...
// Authentication Headings Text
  ...
  static const String loginSubTitle =
      'Khám phá Lựa chọn Vô hạn và Tiện lợi Vô song.';
  static const String signupTitle = 'Hãy tạo tài khoản của bạn';
  static const String forgetPasswordTitle = 'Quên mật khẩu';
  static const String forgetPasswordSubTitle =
      'Đừng lo, đôi khi mọi người cũng quên, hãy nhập email của bạn và chúng tôi sẽ gửi cho bạn một liên kết đặt lại mật khẩu.';
  static const String changeYourPasswordTitle = 'Email đặt lại mật khẩu đã gửi';
  static const String changeYourPasswordSubTitle =
      'Bảo mật Tài khoản của bạn là Ưu tiên của Chúng tôi! Chúng tôi đã gửi cho bạn một liên kết bảo mật để thay đổi mật khẩu của bạn và giữ cho tài khoản của bạn được bảo vệ.';
  static const String confirmEmailTitle = 'Xác minh địa chỉ email của bạn!';
  static const String confirmEmailSubTitle =
      'Chúc mừng! Tài khoản của bạn đang chờ: Xác minh email của bạn để bắt đầu mua sắm và trải nghiệm Thế giới của những Giao dịch Không đối thủ và Ưu đãi Cá nhân hóa.';
  static const String emailNotReceivedMessage =
      'Không nhận được email? Kiểm tra hộp thư rác/spam của bạn hoặc gửi lại.';
  static const String yourAccountCreatedTitle =
      'Tài khoản của bạn đã được tạo thành công!';
  static const String yourAccountCreatedSubTitle =
      'Chào mừng đến với điểm đến mua sắm tối thượng của bạn Tài khoản của bạn đã được tạo, hãy tận hưởng niềm vui mua sắm trực tuyến liền mạch!';
  static const String myContinue = 'Tiếp tục';
  static const String submit = 'Gửi';
  static const String done = 'Thực hiện';
